...
browser.find_element("xpath", ".//*[contains(text(), 'Sign in with')]").click()

# username
wait.until(EC.element_to_be_clickable((By.CSS_SELECTOR, "[name='email']"))).send_keys(login_details.substack_username)
# password
wait.until(EC.element_to_be_clickable((By.CSS_SELECTOR, "[name='password']"))).send_keys(login_details.substack_password)
# continue
